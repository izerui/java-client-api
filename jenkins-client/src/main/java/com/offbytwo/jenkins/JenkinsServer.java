...
public class JenkinsServer implements Closeable {
     ...
     * @throws Exception
     */
    public Map<String, JobWithDetails> getDetailJobs() throws Exception {
        String path = UrlUtils.toBaseUrl(null);
        path += "?depth=1";
        List<JobWithDetails> jobs = client.get(path, DetailJobView.class).getJobs();
